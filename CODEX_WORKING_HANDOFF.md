...
- 2026-07-11: 5.4 mini follow-up intentionally left pending after the production observability patch. Remaining mini scope is to lock the new exit-swap status fields and Telegram wording with focused tests, especially around TP full sweep, residual-balance reporting, and skip-reason visibility.
