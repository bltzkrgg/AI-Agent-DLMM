...
- LP-style Supertrend entry freshness is adaptive, not a raw candle counter: `1-2` closed M15 candles above the Supertrend line are fresh, `3-4` can still pass as late-but-active if price remains close to the Supertrend base, and only clearly extended/cooling reclaim structures should HOLD. Operator wording now distinguishes `bullish but cooling` from a hard rejection.
