...
- Deploy range source should stay active-bin-relative (`min/max bin offset from active bin`) rather than deep percent-offset math; `deployRangeMaxBins` remains only a safety width cap.
