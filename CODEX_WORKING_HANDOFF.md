...
- LP-style Supertrend entry freshness is now deliberately simple: `2+` closed M15 candles above the Supertrend line are enough for entry confirmation, and there is no extra cooling gate on top of that. The operator wording was simplified to match this rule and avoid implying a late-but-tradable gray zone.
